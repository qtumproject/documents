...
No hay otra URL para la billetera web de Qtum, por favor, tengan cuidado y verifiquen el candado verde que dice "Secure"  en el cual pueden corroborar el certificado de seguridad del sitio:
...
Bienvenidos a la documentacion de usuario para la billetera web de Qtum, a continuacion: 
